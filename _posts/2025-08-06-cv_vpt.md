...
description: "本文整理“深度学习·VPT”涉及的模型原理、关键方法与实践要点，便于理解和复习相关技术。"
---
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/55b26e15cc5d4108bdf1951ba5596791.png){: referrerpolicy="no-referrer" }
**每一层**transformer layer的prompt token都是可以学习的参数
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/24a7a77196c047308d3f0b79aa1a07bf.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/72a608f784184aee9c4fda15081a8f38.png){: referrerpolicy="no-referrer" }
## prompt length
+ 可以看到**10~100这个区间**最合适。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4f6cd61febb24a6082e1352a98e0d36b.png){: referrerpolicy="no-referrer" }
