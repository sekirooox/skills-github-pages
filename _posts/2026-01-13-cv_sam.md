...
# 模型架构
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/eec1b9b3ad2741adabdbe8b6a6902f99.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c1abecac4de2412b9b0d73de3ce3febc.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/54eab7a4596643c48dfdc22bfe3944ba.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/32b233d94f344da5b1df1d6690c237e4.png){: referrerpolicy="no-referrer" }



# SAM2
将SAM1从静态图像任务扩展到视频任务上![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/956ad0b276c64df8a8228af2868e6fca.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/980008c3a21c494dbde2bae252ffb3e9.png){: referrerpolicy="no-referrer" }

## 内存注意力
+ 用于将当前帧和过去帧和提示联系起来
+ 当前帧的image embedding和内存银行中的对象指针，提示和之前帧输出的掩膜进行交叉注意里进行改善。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b068b0d898084648893f073054663567.png){: referrerpolicy="no-referrer" }
...
## 掩码解码器
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e3535c69e2cc4a47bdf121d8e2e50f72.png){: referrerpolicy="no-referrer" }
