...
math: true
description: "本文整理“深度学习·ExCEL”涉及的模型原理、关键方法与实践要点，便于理解和复习相关技术。"
---

# WSSS

# ExCEL方法
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8eea166e0e7e4431b259035f19841dcd.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a1e99509d81745ef93494c1f96e7f831.png){: referrerpolicy="no-referrer" }
...
+  作者对这些知识库中的属性进行聚类，得到B个**聚类中心**,其中**B=112或者224**(Pascal VOC or COCO)
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/23e2f30dc41a4a9eb3672685f3ef009c.png){: referrerpolicy="no-referrer" }
 + 给定一个class token,将聚类中心与其计算相似度分数，然后根据分数选取**前K个**进行text embedding的融合，权重就是聚类分数，然后注意有个权重$\lambda$
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/28bd66adc04b499cb55c4129c607cb94.png){: referrerpolicy="no-referrer" }
...
+ ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e1a34c52f5944b85af4e1a8e9ac1a9b5.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0247844a650d4946a1d3f150738b1e92.png){: referrerpolicy="no-referrer" }
+ 训练适配器的损失函数：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/3163e56366ec4166900d2a406a3ffe89.png){: referrerpolicy="no-referrer" }

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/59e7b40efd9649f99f8c892b239692ef.png){: referrerpolicy="no-referrer" }
