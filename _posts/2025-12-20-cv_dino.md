...
教师**网络的输出特征经过中心化处理**。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/3708cb63fbee4ba686346007a6e8c2a6.png){: referrerpolicy="no-referrer" }
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/201b17e6cef94806a171cd60140145e3.png){: referrerpolicy="no-referrer" }

##  DINOv2
注重数据规模化，极大的扩充了数据集，**提高数据质量**


![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0d2543f37ffb4b388f078538641f6e6a.png){: referrerpolicy="no-referrer" }
引入了patch级损失，显示增强patch的区分能力

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/fe3284df81f142bd9986f90528a5950b.png){: referrerpolicy="no-referrer" }
训练末期使用一段时间的**高分辨率**
**使用正则化**，用于**高效划分特征空间**。
教师网络输出的中心化方法也得到了探讨。

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/50845887e8fc45538eea2c4b0286aed1.png){: referrerpolicy="no-referrer" }
| 维度       | DINOv1         | DINOv2                   |
| -------- | -------------- | ------------------------ |
...
* 用余弦相似度作为距离度量：
  $$m(s,r)=\cos(f(s),f(r))=\frac{f(s)\cdot f(r)}{\lVert f(s)\rVert_2\lVert f(r)\rVert_2}$$
  （见附录A.2）。
