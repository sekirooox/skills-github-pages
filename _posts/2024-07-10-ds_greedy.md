...
description: "本文整理“算法·贪心”的核心思路、典型问题与实现要点，便于刷题复习和后续查阅。"
---
...
### 隐式的区间贪心
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/470437c415d54699a7efa3a515a155c6.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/14b1dcb5d59a4c5aa4f0cbceb4037cce.png){: referrerpolicy="no-referrer" }
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/53c0570225d14deab3878202a56385af.png){: referrerpolicy="no-referrer" }
