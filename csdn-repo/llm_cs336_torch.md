...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0372baa157f84052bb68076d8950b32a.png)
### `torch.float16`：基本不用，２个字节
### `torch.bfloat16`：２个字节
+ 特点：和`torch.float32`一样，指数部分精度一致，但是小数部分精度较差。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8819616e50724b38aeb129d065fe3085.png)

### `torch.bf8`:
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d772defd2d954ec6b445b11ce782724b.png)
