...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/8147550551c040ae9016ebc511ec437f.png)
## 具体步骤
### Step1正向化处理
>将所以评价指标转换为极大型，目的是将数据进一步转变为概率
+ #### 将极小型转换为极大型
	极小型是指评价指标越小越好
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/dfd63c9caeff4d098d0c76e32f56e373.png)
+ 代码如下：注意矩阵X可以是列向量
```matlab
...
>中间型是指评价指标越接近最佳值越好，其中最佳值是给出的
	![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0d65107a5a6849d6ab60b9b4de2cda58.png)
...
>区间型是指评价指标在区间内最好，在区间外欠佳
 ![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5dc4b1409d414f609dc147efc512a57d.png)
+ 代码如下
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/aa2bbeb732314e21b8c85413ddc3be64.png)
>标准化的意义：消除计量单位不同造成的影响
### 概率矩阵
>如果说正向化使每个数据是是不是好事的程度，这时候归一化就可以得到好事放生的概率
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/39d450f8f4254ebc8aec6d89aba26e0d.png)
### Step3利用信息熵计算权重集
>注意信息熵的计算公式里有对数，所以应该适当修改概率矩阵值为0的项
	这个公式本质上也是对每一列中所有元素按照公式求和，最后除以ln n归一化处理
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f03c18db25d64264909377be2413a723.png)
## 主体代码
